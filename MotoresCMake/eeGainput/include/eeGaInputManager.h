...
class EE_GAINPUT_EXPORT GaInputManager : public InputManager
{
 ...
 private:
  /**
   * The manager of Gainput
   */
  gainput::InputManager m_manager;
  /**
   * The input map of Gainput
   */
  SPtr<gainput::InputMap> m_inputMap;

  /**
   * An array of device indices and its map of user-Gainput input boolean codes.
   */
  Map<uint32, Map<uint8, uint32>> m_boolKeysMap;
  /**
   * An array of device indices and its map of user-Gainput input float codes.
   */
