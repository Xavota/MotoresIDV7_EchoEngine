...
const BoxAAB BoxAAB::kSIMPLEX(Vector3f(-1.0f, -1.0f, -1.0f),
...
bool
BoxAAB::intersects(const Vector3f& point) const
{
  return Math::intersectionBoxPoint(*this, point);
}
bool
BoxAAB::intersects(const Plane& plane) const
{
  return Math::intersectionBoxPlane(*this, plane);
}
bool
BoxAAB::intersects(const Sphere& sphere)
{
  return Math::intersectionBoxSphere(*this, sphere);
}
bool
BoxAAB::intersects(const BoxAAB& box)
{
  return Math::intersectionBoxBox(*this, box);
}
//bool
//BoxAAB::intersects(const Capsule& capsule)
//{
