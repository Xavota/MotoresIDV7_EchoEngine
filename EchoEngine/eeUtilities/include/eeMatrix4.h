...
public:
   ...
   * Matrix filled with zeros.
   */
  static const Matrix4i kZERO;
  /*
   * Matrix filled with ones.
   */
  static const Matrix4i kONES;
  /*
   * The identity matrix.
   */
  static const Matrix4i kIDENTITY;
};
...
public:
   ...
   * Matrix filled with zeros.
   */
  static const Matrix4u kZERO;
  /*
   * Matrix filled with ones.
   */
  static const Matrix4u kONES;
  /*
   * The identity matrix.
   */
  static const Matrix4u kIDENTITY;
};
}