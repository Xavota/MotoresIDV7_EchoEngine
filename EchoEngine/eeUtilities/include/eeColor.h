...
/**
 * @brief
 * The color class using uint8. Stores rgb values from 0 to 255.
 */
class EE_UTILITY_EXPORT ColorI
{
 public:
  /**
   * @brief
   ...
   * The initial alpha value.
   */
  ColorI(uint8 _r, uint8 _g, uint8 _b, uint8 _a);
  /**
   * @brief
   * Default destructor
   */
   ...
   */
  ColorI
  operator+(const ColorI& other) const;
  /**
   * @brief
   * The subtraction of two colors.
   *
