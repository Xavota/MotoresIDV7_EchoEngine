...
class Capsule
{
  ...
  * @param radious
  * The radious of the demispheres on the top and bottom, and also of the 
  * cylinder body.
  */
  ...
  *
  * @description
  * Returns the radious of the demispheres on the top 
  * and bottom, and also of the cylinder body.
  *
  * @return
  * The radious of the demispheres on the top and bottom, 
  ...
  *
  * @description
  * Changes the radious of the demispheres on the top 
  ...
  *
  * @description
  * Returns true if the firts capsule intersects the second.
  *
  * @param capsule
  ...
  */
  ...
  /**
  * @brief
  * The radious of the demispheres on 
