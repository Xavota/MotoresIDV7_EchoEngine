...
//#endif
   ...
   * Matrix filled with zeros.
   */
  static const Matrix2i kZERO;
  /*
   * Matrix filled with ones.
   */
  static const Matrix2i kONES;
  /*
   * The identity matrix.
   */
  static const Matrix2i kIDENTITY;
};
...
//#endif
   ...
   * Matrix filled with zeros.
   */
  static const Matrix2u kZERO;
  /*
   * Matrix filled with ones.
   */
  static const Matrix2u kONES;
  /*
   * The identity matrix.
   */
  static const Matrix2u kIDENTITY;
};
