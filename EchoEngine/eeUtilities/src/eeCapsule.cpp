...
const Capsule Capsule::kSIMPLEX(Vector3f(0.0f, 0.0f, 0.0f), 2.0f, 0.5f);
...
bool
Capsule::intersects(const Vector3f& point) const
{
  return Math::intersectionCapsulePoint(*this, point);
}
bool
Capsule::intersects(const Plane& plane) const
{
...
//bool
//Capsule::intersects(const BoxAAB& box)
//{
