 ...
 * used.
 */
class EE_PLUGINOGL_EXPORT OGLTexture : public Texture
{
public:
  /**
   * @brief
  ...
  create2D(uint32 bindFlags,
           const Point2D& texSize,
           eTEXTURE_FORMAT::E format = eTEXTURE_FORMAT::kR32G32B32_Float,
...
private:
  /**
   * OGL shader resource view. The buffer that is passed to the graphic memory.
   */
  uint32 m_shaderResource = 0u;
  /**
   * The OGL render target.
   */
