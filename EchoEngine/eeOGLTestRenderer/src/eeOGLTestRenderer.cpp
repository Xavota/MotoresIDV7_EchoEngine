...
OGLTestRenderer::OGLTestRenderer()
{
  ...
  resourceManager.loadVertexShaderFromFile(L"D:/GitHub/MotoresIDV7_EchoEngine/EchoEngine/bin/Shaders/OGLTestShaderVS.glsl",
                                           "main",
                                           {},
                                           "TestVS");
  resourceManager.loadPixelShaderFromFile(L"D:/GitHub/MotoresIDV7_EchoEngine/EchoEngine/bin/Shaders/OGLTestShaderPS.glsl",
                                          "main",
                                          {},
                                          "TestPS");
